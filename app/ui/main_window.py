...
from app.ui.gbif_analysis_tab import GbifAnalysisTab
...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.workspace_tabs.addTab(MappingTab(content_splitter, self), "GBIF 매핑")
        self.workspace_tabs.addTab(GbifAnalysisTab(self.settings, self), "GBIF 분석")

        root_layout.addWidget(self.workspace_tabs)
        root_layout.setStretchFactor(self.workspace_tabs, 1)
        ...
        self.setStyleSheet(
            ...
            QFrame[class="sectionCard"], QGroupBox[class="sectionCard"] {
                background: #fbfdff;
